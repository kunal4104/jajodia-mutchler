...
public class Main {
    public static void main(String[] args) {
        StateObj serverState = new StateObj(args[0]);
...
class StateObj {
    ...
    public StateObj(String serverName) {
        ...
        this.servList.put("B", new Node("B", "10.176.69.33", 8000)); 
        this.servList.put("C", new Node("C", "10.176.69.34", 8000)); 
        this.servList.put("D", new Node("D", "10.176.69.35", 8000));
        this.servList.put("E", new Node("E", "10.176.69.36", 8000)); 
        this.servList.put("F", new Node("F", "10.176.69.37", 8000)); 
        this.servList.put("G", new Node("G", "10.176.69.38", 8000)); 
        this.servList.put("H", new Node("H", "10.176.69.39", 8000));
